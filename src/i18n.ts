...
const I18N_IMPORTERS: Record<string, Record<string, () => Promise<ElectionI18nModule>>> = {
  ...
  'darmstadt-kav': {
    de: () => import('./elections/darmstadt-kav/i18n/de.json'),
    en: () => import('./elections/darmstadt-kav/i18n/en.json'),
    tr: () => import('./elections/darmstadt-kav/i18n/tr.json'),
    ar: () => import('./elections/darmstadt-kav/i18n/ar.json'),
    uk: () => import('./elections/darmstadt-kav/i18n/uk.json'),
    ru: () => import('./elections/darmstadt-kav/i18n/ru.json'),
  },
  'fulda-kav': {
    de: () => import('./elections/fulda-kav/i18n/de.json'),
    en: () => import('./elections/fulda-kav/i18n/en.json'),
    tr: () => import('./elections/fulda-kav/i18n/tr.json'),
    ar: () => import('./elections/fulda-kav/i18n/ar.json'),
    uk: () => import('./elections/fulda-kav/i18n/uk.json'),
    ru: () => import('./elections/fulda-kav/i18n/ru.json'),
  },
  'giessen-kav': {
    de: () => import('./elections/giessen-kav/i18n/de.json'),
    en: () => import('./elections/giessen-kav/i18n/en.json'),
    tr: () => import('./elections/giessen-kav/i18n/tr.json'),
    ar: () => import('./elections/giessen-kav/i18n/ar.json'),
    uk: () => import('./elections/giessen-kav/i18n/uk.json'),
    ru: () => import('./elections/giessen-kav/i18n/ru.json'),
  },
  'hanau-kav': {
    de: () => import('./elections/hanau-kav/i18n/de.json'),
    en: () => import('./elections/hanau-kav/i18n/en.json'),
    tr: () => import('./elections/hanau-kav/i18n/tr.json'),
    ar: () => import('./elections/hanau-kav/i18n/ar.json'),
    uk: () => import('./elections/hanau-kav/i18n/uk.json'),
    ru: () => import('./elections/hanau-kav/i18n/ru.json'),
  },
  'kassel-kav': {
    de: () => import('./elections/kassel-kav/i18n/de.json'),
    en: () => import('./elections/kassel-kav/i18n/en.json'),
    tr: () => import('./elections/kassel-kav/i18n/tr.json'),
    ar: () => import('./elections/kassel-kav/i18n/ar.json'),
    uk: () => import('./elections/kassel-kav/i18n/uk.json'),
    ru: () => import('./elections/kassel-kav/i18n/ru.json'),
  },
  'marburg-kav': {
    de: () => import('./elections/marburg-kav/i18n/de.json'),
    en: () => import('./elections/marburg-kav/i18n/en.json'),
    tr: () => import('./elections/marburg-kav/i18n/tr.json'),
    ar: () => import('./elections/marburg-kav/i18n/ar.json'),
    uk: () => import('./elections/marburg-kav/i18n/uk.json'),
    ru: () => import('./elections/marburg-kav/i18n/ru.json'),
  },
  'offenbach-kav': {
    de: () => import('./elections/offenbach-kav/i18n/de.json'),
    en: () => import('./elections/offenbach-kav/i18n/en.json'),
    tr: () => import('./elections/offenbach-kav/i18n/tr.json'),
    ar: () => import('./elections/offenbach-kav/i18n/ar.json'),
    uk: () => import('./elections/offenbach-kav/i18n/uk.json'),
    ru: () => import('./elections/offenbach-kav/i18n/ru.json'),
  },
  'ruesselsheim-kav': {
    de: () => import('./elections/ruesselsheim-kav/i18n/de.json'),
    en: () => import('./elections/ruesselsheim-kav/i18n/en.json'),
    tr: () => import('./elections/ruesselsheim-kav/i18n/tr.json'),
    ar: () => import('./elections/ruesselsheim-kav/i18n/ar.json'),
  ...
  'bad-homburg-stvv': {
    de: () => import('./elections/bad-homburg-stvv/i18n/de.json'),
    en: () => import('./elections/bad-homburg-stvv/i18n/en.json'),
    tr: () => import('./elections/bad-homburg-stvv/i18n/tr.json'),
    ar: () => import('./elections/bad-homburg-stvv/i18n/ar.json'),
    uk: () => import('./elections/bad-homburg-stvv/i18n/uk.json'),
    ru: () => import('./elections/bad-homburg-stvv/i18n/ru.json'),
  },
  'wetzlar-stvv': {
    de: () => import('./elections/wetzlar-stvv/i18n/de.json'),
    en: () => import('./elections/wetzlar-stvv/i18n/en.json'),
    tr: () => import('./elections/wetzlar-stvv/i18n/tr.json'),
    ar: () => import('./elections/wetzlar-stvv/i18n/ar.json'),
    uk: () => import('./elections/wetzlar-stvv/i18n/uk.json'),
    ru: () => import('./elections/wetzlar-stvv/i18n/ru.json'),
  },
  'amberg-stadtrat': {
    de: () => import('./elections/amberg-stadtrat/i18n/de.json'),
    en: () => import('./elections/amberg-stadtrat/i18n/en.json'),
    tr: () => import('./elections/amberg-stadtrat/i18n/tr.json'),
    ar: () => import('./elections/amberg-stadtrat/i18n/ar.json'),
    uk: () => import('./elections/amberg-stadtrat/i18n/uk.json'),
    ru: () => import('./elections/amberg-stadtrat/i18n/ru.json'),
  },
  'coburg-stadtrat': {
    de: () => import('./elections/coburg-stadtrat/i18n/de.json'),
    en: () => import('./elections/coburg-stadtrat/i18n/en.json'),
    tr: () => import('./elections/coburg-stadtrat/i18n/tr.json'),
    ar: () => import('./elections/coburg-stadtrat/i18n/ar.json'),
    uk: () => import('./elections/coburg-stadtrat/i18n/uk.json'),
    ru: () => import('./elections/coburg-stadtrat/i18n/ru.json'),
  },
  'kempten-stadtrat': {
    de: () => import('./elections/kempten-stadtrat/i18n/de.json'),
    en: () => import('./elections/kempten-stadtrat/i18n/en.json'),
    tr: () => import('./elections/kempten-stadtrat/i18n/tr.json'),
    ar: () => import('./elections/kempten-stadtrat/i18n/ar.json'),
    uk: () => import('./elections/kempten-stadtrat/i18n/uk.json'),
    ru: () => import('./elections/kempten-stadtrat/i18n/ru.json'),
  },
  'schweinfurt-stadtrat': {
    de: () => import('./elections/schweinfurt-stadtrat/i18n/de.json'),
    en: () => import('./elections/schweinfurt-stadtrat/i18n/en.json'),
    tr: () => import('./elections/schweinfurt-stadtrat/i18n/tr.json'),
    ar: () => import('./elections/schweinfurt-stadtrat/i18n/ar.json'),
    uk: () => import('./elections/schweinfurt-stadtrat/i18n/uk.json'),
    ru: () => import('./elections/schweinfurt-stadtrat/i18n/ru.json'),
  },
  'rosenheim-stadtrat': {
    de: () => import('./elections/rosenheim-stadtrat/i18n/de.json'),
    en: () => import('./elections/rosenheim-stadtrat/i18n/en.json'),
    tr: () => import('./elections/rosenheim-stadtrat/i18n/tr.json'),
    ar: () => import('./elections/rosenheim-stadtrat/i18n/ar.json'),
    uk: () => import('./elections/rosenheim-stadtrat/i18n/uk.json'),
    ru: () => import('./elections/rosenheim-stadtrat/i18n/ru.json'),
  },
  'straubing-stadtrat': {
    de: () => import('./elections/straubing-stadtrat/i18n/de.json'),
    en: () => import('./elections/straubing-stadtrat/i18n/en.json'),
    tr: () => import('./elections/straubing-stadtrat/i18n/tr.json'),
    ar: () => import('./elections/straubing-stadtrat/i18n/ar.json'),
    uk: () => import('./elections/straubing-stadtrat/i18n/uk.json'),
    ru: () => import('./elections/straubing-stadtrat/i18n/ru.json'),
  },
  'hof-stadtrat': {
    de: () => import('./elections/hof-stadtrat/i18n/de.json'),
    en: () => import('./elections/hof-stadtrat/i18n/en.json'),
    tr: () => import('./elections/hof-stadtrat/i18n/tr.json'),
    ar: () => import('./elections/hof-stadtrat/i18n/ar.json'),
    uk: () => import('./elections/hof-stadtrat/i18n/uk.json'),
    ru: () => import('./elections/hof-stadtrat/i18n/ru.json'),
  },
  'passau-stadtrat': {
    de: () => import('./elections/passau-stadtrat/i18n/de.json'),
    en: () => import('./elections/passau-stadtrat/i18n/en.json'),
    tr: () => import('./elections/passau-stadtrat/i18n/tr.json'),
    ar: () => import('./elections/passau-stadtrat/i18n/ar.json'),
    uk: () => import('./elections/passau-stadtrat/i18n/uk.json'),
    ru: () => import('./elections/passau-stadtrat/i18n/ru.json'),
  },
  'landshut-stadtrat': {
    de: () => import('./elections/landshut-stadtrat/i18n/de.json'),
    en: () => import('./elections/landshut-stadtrat/i18n/en.json'),
    tr: () => import('./elections/landshut-stadtrat/i18n/tr.json'),
    ar: () => import('./elections/landshut-stadtrat/i18n/ar.json'),
    uk: () => import('./elections/landshut-stadtrat/i18n/uk.json'),
    ru: () => import('./elections/landshut-stadtrat/i18n/ru.json'),
  },
  'weiden-stadtrat': {
    de: () => import('./elections/weiden-stadtrat/i18n/de.json'),
    en: () => import('./elections/weiden-stadtrat/i18n/en.json'),
    tr: () => import('./elections/weiden-stadtrat/i18n/tr.json'),
    ar: () => import('./elections/weiden-stadtrat/i18n/ar.json'),
    uk: () => import('./elections/weiden-stadtrat/i18n/uk.json'),
    ru: () => import('./elections/weiden-stadtrat/i18n/ru.json'),
  },
  'schwabach-stadtrat': {
    de: () => import('./elections/schwabach-stadtrat/i18n/de.json'),
    en: () => import('./elections/schwabach-stadtrat/i18n/en.json'),
    tr: () => import('./elections/schwabach-stadtrat/i18n/tr.json'),
    ar: () => import('./elections/schwabach-stadtrat/i18n/ar.json'),
    uk: () => import('./elections/schwabach-stadtrat/i18n/uk.json'),
    ru: () => import('./elections/schwabach-stadtrat/i18n/ru.json'),
  },
  'aschaffenburg-stadtrat': {
    de: () => import('./elections/aschaffenburg-stadtrat/i18n/de.json'),
    en: () => import('./elections/aschaffenburg-stadtrat/i18n/en.json'),
    tr: () => import('./elections/aschaffenburg-stadtrat/i18n/tr.json'),
    ar: () => import('./elections/aschaffenburg-stadtrat/i18n/ar.json'),
    uk: () => import('./elections/aschaffenburg-stadtrat/i18n/uk.json'),
    ru: () => import('./elections/aschaffenburg-stadtrat/i18n/ru.json'),
  },
  'kaufbeuren-stadtrat': {
    de: () => import('./elections/kaufbeuren-stadtrat/i18n/de.json'),
    en: () => import('./elections/kaufbeuren-stadtrat/i18n/en.json'),
    tr: () => import('./elections/kaufbeuren-stadtrat/i18n/tr.json'),
    ar: () => import('./elections/kaufbeuren-stadtrat/i18n/ar.json'),
    uk: () => import('./elections/kaufbeuren-stadtrat/i18n/uk.json'),
    ru: () => import('./elections/kaufbeuren-stadtrat/i18n/ru.json'),
  },
  'memmingen-stadtrat': {
    de: () => import('./elections/memmingen-stadtrat/i18n/de.json'),
    en: () => import('./elections/memmingen-stadtrat/i18n/en.json'),
    tr: () => import('./elections/memmingen-stadtrat/i18n/tr.json'),
    ar: () => import('./elections/memmingen-stadtrat/i18n/ar.json'),
    uk: () => import('./elections/memmingen-stadtrat/i18n/uk.json'),
    ru: () => import('./elections/memmingen-stadtrat/i18n/ru.json'),
  },
};
